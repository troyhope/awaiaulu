    ...
    return (
      <Html lang="en">
        <Head>
          ...
          {/*  KaTex - unsure what it was ever used for??
         <link
            rel="preload"
        ...
        <body className="antialiased font-sans text-black bg-white dark:bg-gray-900 dark:text-white">
          <Main />
          <NextScript />
        </body>
      </Html>
